...
sudo pacman -S alacritty base-devel bluetui btop dolphin firefox flatpak fuzzel gnome-keyring grim hyprland hyprpaper libsecret nvim polkit-gnome seahorse signal-desktop waybar
